function tag = argon2i(P, S, p, T, m, t, K, X)
% argon2i - Compute the tag of P using the Argon2i algorithm
% 
% Syntax: 
%   tag = ARGON2I(P, S, p, T, m, t, K, X)
%   tag = ARGON2I(P, S, p, T, m, t)
% 
% Input Arguments
%   P - Message string
...
%   https://datatracker.ietf.org/doc/html/rfc9106.html
    ...
    tag = argon2impl.argon2(P, S, p, T, m, t, 1, K, X);
end
