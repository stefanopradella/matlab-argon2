function tag = argon2d(P, S, p, T, m, t, K, X)
% argon2d - Compute the tag of P using the Argon2d algorithm
% 
% Syntax: 
%   tag = ARGON2D(P, S, p, T, m, t, K, X)
%   tag = ARGON2D(P, S, p, T, m, t)
% 
% Input Arguments
%   P - Message string
...
%   https://datatracker.ietf.org/doc/html/rfc9106.html
    ...
    tag = argon2impl.argon2(P, S, p, T, m, t, 0, K, X);
end
